...
<body>
  ...
  <section id="hero">
    <div class="hero-container">
      <h3>Welcome to <strong>OUR Website</strong></h3>
      <h1>Here you can find everthing related to your academics. </h1>
      <h2>All the things related to GTU and College will be available here.</h2>
    ...
    <section id="cta" class="cta">
      <div class="container">
        ...
        <div class="text-center">
          ...
          <p>If you have any query regarding Features Section then feel free to write it over here.</p>
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              <li data-filter=".filter-app" class="filter-active">Sem 2</li>
        ...
        <ul class="faq-list">
          ...
          <li>
            ...
            <div id="faq1" class="collapse" data-bs-parent=".faq-list">
              <p>
                Here you can find everthing related to your academics and all the things related to GTU and College will be available here.
              </p>
            </div>
          </li>
          ...
          <li>
            ...
            <div id="faq2" class="collapse" data-bs-parent=".faq-list">
              <p>
                Website is developed in such a way that it can be used by both Faculties as well as Students.
              </p>
            </div>
          </li>
          ...
          <li>
            ...
            <div id="faq3" class="collapse" data-bs-parent=".faq-list">
              <p>
                It provides functionalites such as Students can see their Assignments assigned by the Faculties. Also, they can find their result of all the exams in this Website only. 
              </p>
            </div>
          </li>
    ...
    <section id="team" class="team">
      <div class="container">
        ...
        <div class="section-title">
          ...
          <p>Here are the members and the leader of the team.</p>
        </div>
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Safrrony Institute of Technology,Mehsana</p>
              </div>

              <div class="email">
                <i class="bi bi-envelope"></i>
                <h4>Email:</h4>
                <p>180390107009@saffrony.ac.in</p>
              </div>
