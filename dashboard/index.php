                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Harsh Pethani</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            ...
                            <div class="card shadow mb-1">
                                ...
                                <div class="card-body" >
                                    <p align="justify">The Purpose of the project is to design an effective website for students where they can get their all information.
                                    After taking reviews from students, we came to an  observation that students were facing problems  of finding all the study material and the upcomming events list at one place.
                                     ...
                                     The another feature will be that the students can compare themselves with the another students.</p>
                                </div>
                            </div>
